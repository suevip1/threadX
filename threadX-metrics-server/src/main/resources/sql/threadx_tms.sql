...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='线程池的监控数据';
...
) ENGINE=InnoDB AUTO_INCREMENT=132 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='线程池内任务执行信息';
...
INSERT INTO `user` (`id`, `user_name`, `password`, `nick_name`, `email`, `state`, `create_time`, `update_time`) VALUES (2, 'zanzan', '$2a$10$7adq/2vocU3Bclhonq8mT.DSEZlVU/wTb2uVfeZwEJWHhCI7zo0Wa', '昝', 'zanzan@qq.com', '0', 1685770152606, 1685770152606);
COMMIT;
